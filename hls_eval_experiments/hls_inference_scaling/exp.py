...
from hls_eval.prompts import prompt_dataflow
...
EXP_NAME = "hls_inference_scaling"
...
if __name__ == "__main__":
    ...
    N_DESIGNS = 16
    all_benchmark_cases = all_benchmark_cases[:N_DESIGNS]
