...
if __name__ == "__main__":
    ...
    # [
    #     "floyd-warshall__google_gemma_2_27b_it",
    #     "gemver__google_gemma_2_27b_it",
    #     "heat-3d__google_gemma_2_27b_it",
    #     "heat-3d__meta_llama_llama_3_8b_chat_hf",
    #     "mix_columns__google_gemma_2_27b_it",
    #     "mix_columns__meta_llama_llama_3_70b_chat_hf",
    #     "mix_columns__meta_llama_llama_3_8b_chat_hf",
    #     "monobit__qwen_qwen2.5_coder_32b_instruct",
    #     "monobit__google_gemma_2_27b_it",
    #     "monobit__meta_llama_llama_3_70b_chat_hf",
    #     "monobit__meta_llama_llama_3_8b_chat_hf",
    #     "mvt__qwen_qwen2.5_coder_32b_instruct",
    #     "mvt__google_gemma_2_27b_it",
    #     "mvt__meta_llama_llama_3_70b_chat_hf",
    # ]

    one_off_cases = [
        ("floyd-warshall", "openai/gpt-4o-mini"),
        # ("gemver", "openai/gpt-4o-mini"),
        # ("heat-3d", "openai/gpt-4o-mini"),
        # ("heat-3d", "meta-llama/llama-3.1-8b-instruct"),
        # ("mix_columns", "openai/gpt-4o-mini"),
        # ("mix_columns", "meta-llama/llama-3.1-8b-instruct"),
        # ("monobit", "openai/gpt-4o-mini"),
        # ("mvt", "openai/gpt-4o-mini"),
    ]
